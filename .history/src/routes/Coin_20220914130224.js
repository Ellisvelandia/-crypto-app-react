        ...
        <div className="content">
          <table>
            ...
            <tbody>
              ...
              <td>{coin.market_data?.price_change_percentage_1h_in_currrency ? <p>{coin.data.price_change_percentage_14d_in_currrency.usd}</p> : null}</td>
              <td>{coin.market_data?.price_change_percentage_1h_in_currrency ? <p>{coin.data.price_change_percentage_30d_in_currrency.usd}</p> : null}</td>
              <td>{coin.market_data?.price_change_percentage_1h_in_currrency ? <p>{coin.data.price_change_percentage_1y_in_currrency.usd}</p> : null}</td>
